...
class DcubeLogParser:
    ...
    def calc_statistics_bv(self, stat_calc) -> None:
        ...
        if self.tempwise:
            ...
            stat_calc.write_stats(self.physical_layer)
...
if __name__ == '__main__':
    ...
    if args.bv == 1:
        ...
        if parser.tempwise:
            ...
            err_dicts = stat_calc.get_error_positions_dictionary()
            corr_err_dicts = stat_calc.get_corrected_error_positions_dictionary()
            parser.plot_errors(plotter, err_dicts, corr_err_dicts)
            print('---------FFT---------\n')
